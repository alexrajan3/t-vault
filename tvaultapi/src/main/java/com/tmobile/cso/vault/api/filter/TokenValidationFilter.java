...
public class TokenValidationFilter extends GenericFilterBean {
	...
	private static final String TOKEN_VALIDATION_MSG = "TokenValidationFilter - doFilter";
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
		...
		log.debug(JSONUtil.getJSON(ImmutableMap.<String, String>builder().
				...
				put(LogMessage.ACTION, TOKEN_VALIDATION_MSG).
		...
		userDetails = setUserDetails(request, clientToken, vaultTokenLookupDetails, userDetails);
	...
	private UserDetails setUserDetails(ServletRequest request, String clientToken,
			VaultTokenLookupDetails vaultTokenLookupDetails, UserDetails userDetails) {
		if (vaultTokenLookupDetails != null && vaultTokenLookupDetails.isValid()) {
			...
			userDetails.setSudoPolicies(null); //Pre-flight
			userDetails.setUsername(vaultTokenLookupDetails.getUsername());
			userDetails.setLeaseDuration(null); //Pre-flight
